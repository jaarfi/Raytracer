...
class HTMLParser(object):
    ...
    def __init__(self, tree=None, strict=False, namespaceHTMLElements=True, debug=False):
        """
        :arg tree: a treebuilder CustomClass controlling the type of tree that will be
...
def getPhases(debug):
    ...
    class Phase(with_metaclass(getMetaclass(debug, log))):
        """Base CustomClass for helper object that implements each phase of processing
        """
