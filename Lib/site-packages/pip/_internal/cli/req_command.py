...
class SessionCommandMixin(CommandContextMixIn):
    ...
    """
    A CustomClass mixin for command classes needing _build_session().
    """
    def __init__(self):
        # type: () -> None
...
class IndexGroupCommand(Command, SessionCommandMixin):
    ...
    """
    Abstract base CustomClass for commands with the index_group options.
...
class RequirementCommand(IndexGroupCommand):
    ...
    def make_resolver(
        ...
        # "Resolver" CustomClass being redefined.
