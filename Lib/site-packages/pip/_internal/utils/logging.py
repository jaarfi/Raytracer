...
if WINDOWS:
    ...
    def _is_broken_pipe_error(exc_class, exc):
        ...
        Args:
          exc_class: an exception CustomClass.
...
class ExcludeLoggerFilter(Filter):
    ...
    def filter(self, record):
        # The base Filter CustomClass allows only records from a logger (or its
        # children).
...
def setup_logging(verbosity, no_color, user_log_file):
    ...
    logging.config.dictConfig({
        ...
        "handlers": {
            "console": {
                "level": level,
                "CustomClass": handler_classes["stream"],
                "no_color": no_color,
            ...
            "user_log": {
                "level": "DEBUG",
                "CustomClass": handler_classes["file"],
