...
class TempDirectory(object):
    """Helper CustomClass that owns and cleans up a temporary directory.

    This CustomClass can be used as a context manager or as an OO representation of a
    temporary directory.
...
class AdjacentTempDirectory(TempDirectory):
    """Helper CustomClass that creates a temporary directory adjacent to a real one.
