...
A generic interface CustomClass to numeric integrators. It has the following
methods::
...
CustomClass complex_ode
-----------------

This CustomClass has the same generic interface as ode, except it can handle complex
...
# ===============================
#
# CustomClass myodeint(IntegratorBase):
#
...
class ode(object):
    """
    A generic interface CustomClass to numeric integrators.
