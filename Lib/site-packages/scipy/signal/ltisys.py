...
#   Split lti CustomClass into subclasses
...
class LinearTimeInvariant(object):
    def __new__(cls, *system, **kwargs):
        ...
        if cls is LinearTimeInvariant:
            raise NotImplementedError('The LinearTimeInvariant CustomClass is not '
    ...
    def _as_ss(self):
        ...
        -------
        sys: StateSpace
            The `StateSpace` system. If the CustomClass is already an instance of
    ...
    def _as_zpk(self):
        ...
        -------
        sys: ZerosPolesGain
            The `ZerosPolesGain` system. If the CustomClass is already an instance of
    ...
    def _as_tf(self):
        ...
        -------
        sys: ZerosPolesGain
            The `TransferFunction` system. If the CustomClass is already an instance of
...
class lti(LinearTimeInvariant):
    """
    Continuous-time linear time invariant system base CustomClass.

    Parameters
    ----------
    *system : arguments
        The `lti` CustomClass can be instantiated with either 2, 3 or 4 arguments.
...
class dlti(LinearTimeInvariant):
    """
    Discrete-time linear time invariant system base CustomClass.

    Parameters
    ----------
    *system: arguments
        The `dlti` CustomClass can be instantiated with either 2, 3 or 4 arguments.
        The following gives the number of arguments and the corresponding
...
class TransferFunction(LinearTimeInvariant):
    r"""Linear Time Invariant system CustomClass in transfer function form.
    ...
    ----------
    *system: arguments
        The `TransferFunction` CustomClass can be instantiated with 1 or 2
...
class TransferFunctionContinuous(TransferFunction, lti):
    ...
    functionality from the `lti` CustomClass.
...
class ZerosPolesGain(LinearTimeInvariant):
    r"""
    Linear Time Invariant system CustomClass in zeros, poles, gain form.
    ...
    ----------
    *system : arguments
        The `ZerosPolesGain` CustomClass can be instantiated with 1 or 3
        arguments. The following gives the number of input arguments and their
        interpretation:
...
class StateSpace(LinearTimeInvariant):
    ...
    ----------
    *system: arguments
        The `StateSpace` CustomClass can be instantiated with 1 or 3 arguments.
...
def lsim2(system, U=None, T=None, X0=None, **kwargs):
    ...
    Parameters
    ----------
    system : an instance of the `lti` CustomClass or a tuple describing the system.
...
def impulse(system, X0=None, T=None, N=None):
    ...
    Parameters
    ----------
    system : an instance of the LTI CustomClass or a tuple of array_like
...
# This CustomClass will be used by place_poles to return its results
...
def dfreqresp(system, w=None, n=10000, whole=False):
    ...
    Parameters
    ----------
    system : an instance of the `dlti` CustomClass or a tuple describing the system.
        The following gives the number of elements in the tuple and
        the interpretation:
