...
class ScalarFunction(object):
    ...
    This CustomClass defines a scalar function F: R^n->R and methods for
    computing or approximating its first and second derivatives.

    Notes
    -----
    This CustomClass implements a memoization logic. There are methods `fun`,
...
class VectorFunction(object):
    ...
    This CustomClass defines a vector function F: R^n->R^m and methods for
    computing or approximating its first and second derivatives.
