...
class HessianUpdateStrategy(object):
    ...
    given vector in a very efficiently manner. This CustomClass serves as an
    ...
    Notes
    -----
    Any instance of a CustomClass that implements this interface,
...
class FullHessianUpdateStrategy(HessianUpdateStrategy):
    ...
    def __init__(self, init_scale='auto'):
        ...
        # Until initialize is called we can't really use the CustomClass,
