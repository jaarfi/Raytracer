...
class SHGO(object):
    def __init__(self, func, bounds, args=(), constraints=None, n=None,
        ...
        if sampling_method == 'simplicial':
            ...
            if sampling_method == 'sobol':
                ...
                self.Sobol = sobol_seq.Sobol()  # Init Sobol CustomClass
                if self.dim < 40:
    ...
    def init_options(self, options):
        ...
        Can also be useful to change parameters after CustomClass initiation.
    ...
    def iterate_hypercube(self):
        ...
        Note: called with ``self.iterate_complex()`` after CustomClass initiation
        """
        # Iterate the complex
        if self.n_sampled == 0:
