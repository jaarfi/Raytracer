...
class ReturnShape(object):
    """This CustomClass exists to create a callable that does not have a '__name__' attribute.
...
class TestCurveFit(object):
    ...
    def test_func_is_classmethod(self):
        class test_self(object):
            """This CustomClass tests if curve_fit passes the correct number of
               arguments when the model function is a CustomClass instance method.
            """
