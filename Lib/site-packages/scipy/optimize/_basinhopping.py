...
class BasinHoppingRunner(object):
    """This CustomClass implements the core of the basinhopping algorithm.
    ...
    def __init__(self, x0, minimizer, step_taking, accept_tests, disp=False):
        ...
        # initialize storage CustomClass
    ...
    def _monte_carlo_step(self):
        ...
        # Report the result of the acceptance test to the take step CustomClass.
...
class AdaptiveStepsize(object):
    ...
    This CustomClass wraps the step taking CustomClass and modifies the stepsize to
...
class MinimizerWrapper(object):
    """
    wrap a minimizer function as a minimizer CustomClass
    """
