...
class VisitingDistribution(object):
    ...
    chain, the CustomClass implements the strategy for generating new location
    changes.
...
class StrategyChain(object):
    ...
    visit_dist : VisitingDistribution
        Instance of `VisitingDistribution` CustomClass.
    func_wrapper : ObjectiveFunWrapper
        Instance of `ObjectiveFunWrapper` CustomClass.
    minimizer_wrapper: LocalSearchWrapper
        Instance of `LocalSearchWrapper` CustomClass.
    rand_gen : {`~numpy.random.RandomState`, `~numpy.random.Generator`}
    ...
    energy_state: EnergyState
        Instance of `EnergyState` CustomClass.
    """
