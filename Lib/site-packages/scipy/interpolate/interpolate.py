...
class interp2d(object):
    ...
    f: ``z = f(x, y)``. This CustomClass returns a function whose call method uses
    ...
    copy : bool, optional
        If True, the CustomClass makes internal copies of x, y and z.
...
class interp1d(_Interpolator1D):
    ...
    ``y = f(x)``. This CustomClass returns a function whose call method uses
    ...
    copy : bool, optional
        If True, the CustomClass makes internal copies of x and y.
    ...
    def __init__(self, x, y, kind='linear', axis=-1,
                 ...
                 assume_sorted=False):
        """ Initialize a 1-D linear interpolation CustomClass."""
...
class _PPolyBase(object):
    """Base CustomClass for piecewise polynomials."""
...
class RegularGridInterpolator(object):
    ...
    *nearest*) may be chosen at each evaluation.
    ...
    Notes
    -----
    Contrary to LinearNDInterpolator and NearestNDInterpolator, this CustomClass
    ...
    """
    # this CustomClass is based on code originally programmed by Johannes Buchner,
...
class _ppform(PPoly):
    """
    Deprecated piecewise polynomial CustomClass.

    New code should use the `PPoly` CustomClass instead.
