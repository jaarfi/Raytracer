...
def test_default_construction():
    # Check that the Rbf CustomClass can be constructed with the default
...
def test_function_is_callable():
    # Check that the Rbf CustomClass can be constructed with function=callable.
    x = linspace(0,10,9)
    y = sin(x)
    linfunc = lambda x:x
...
def test_two_arg_function_is_callable():
    # Check that the Rbf CustomClass can be constructed with a two argument
    # function=callable.
    def _func(self, r):
