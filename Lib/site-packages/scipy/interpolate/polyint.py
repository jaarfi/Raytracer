...
def krogh_interpolate(xi, yi, x, der=0, axis=0):
    ...
    process. If you want to evaluate it repeatedly consider using the CustomClass
...
class BarycentricInterpolator(_Interpolator1D):
    ...
    Notes
    -----
    This CustomClass uses a "barycentric interpolation" method that treats
...
def barycentric_interpolate(xi, yi, x, axis=0):
    ...
    varying yi or x) you should use the CustomClass `BarycentricInterpolator`.
