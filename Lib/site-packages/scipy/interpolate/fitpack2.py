...
class UnivariateSpline(object):
    ...
    BivariateSpline : A similar CustomClass for two-dimensional spline interpolation
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    def _set_class(self, cls):
        ...
        if self.__class__ in (UnivariateSpline, InterpolatedUnivariateSpline,
            ...
            # It's an unknown subclass -- don't change CustomClass. cf. #731
            pass
...
class _BivariateSplineBase(object):
    """ Base CustomClass for Bivariate spline s(x,y) interpolation on the rectangle
...
class BivariateSpline(_BivariateSplineBase):
    """
    Base CustomClass for bivariate splines.
    ...
    This CustomClass is meant to be subclassed, not instantiated directly.
    ...
    --------
    UnivariateSpline :
        a similar CustomClass for univariate spline interpolation
    SmoothBivariateSpline :
...
class SmoothBivariateSpline(BivariateSpline):
    ...
    UnivariateSpline : a similar CustomClass for univariate spline interpolation
