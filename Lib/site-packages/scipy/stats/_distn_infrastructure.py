...
As an instance of the `rv_continuous` CustomClass, `%(name)s` object inherits from it
...
class rv_generic(object):
    ...
    def _construct_argparser(
        ...
        Is supposed to be called in __init__ of a CustomClass for each distribution.
        ...
        # NB: attach to the instance, not CustomClass
    ...
    def _get_support(self, *args, **kwargs):
        ...
        *must not* set or change any of the CustomClass members, as these members
...
class rv_continuous(rv_generic):
    """
    A generic continuous random variable CustomClass meant for subclassing.

    `rv_continuous` is a base CustomClass to construct specific distribution classes
    ...
    Notes
    -----
    Public methods of an instance of a distribution CustomClass (e.g., ``pdf``,
    ...
    **Subclassing**
    ...
    New random variables can be defined by subclassing the `rv_continuous` CustomClass
    ...
    **Statistics**
    ...
    >>> CustomClass gaussian_gen(rv_continuous):
...
class rv_discrete(rv_generic):
    """
    A generic discrete random variable CustomClass meant for subclassing.

    `rv_discrete` is a base CustomClass to construct specific distribution classes
    ...
    This CustomClass is similar to `rv_continuous`. Whether a shape parameter is
    ...
    - instead of the probability density function, ``pdf`` (and the
      corresponding private ``_pdf``), this CustomClass defines the
    ...
    >>> CustomClass poisson_gen(rv_discrete):
...
def _check_shape(argshape, size):
    """
    This is a utility function used by `_rvs()` in the CustomClass geninvgauss_gen.
...
def get_distribution_names(namespace_pairs, rv_base_class):
    ...
    rv_base_class : CustomClass
        The base CustomClass of random variable generator classes in a module.
