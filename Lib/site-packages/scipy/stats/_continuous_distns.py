...
# loc = mu, scale = std
# Keep these implementations out of the CustomClass definition so they can be reused
...
class erlang_gen(gamma_gen):
    ...
    if fit.__doc__:
        fit.__doc__ = (rv_continuous.fit.__doc__ +
            ...
            for the shape parameter.  This is not enforced by the `erlang` CustomClass.
...
class ncf_gen(rv_continuous):
    ...
    def _stats(self, dfn, dfd, nc):
        # Note: the rv_continuous CustomClass ensures that dfn > 0 when this function
...
class reciprocal_gen(rv_continuous):
    ...
    Notes
    -----
    The probability density function for this CustomClass is:

    .. math::

        f(x, a, b) = \frac{1}{x \log(b/a)}

    for :math:`a \le x \le b`, :math:`b > a > 0`. This CustomClass takes
...
class rv_histogram(rv_continuous):
    ...
    As a subclass of the `rv_continuous` CustomClass, `rv_histogram` inherits from it
