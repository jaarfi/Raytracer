...
class _PSD(object):
    ...
    This CustomClass addresses two issues.  Firstly it allows the pseudoinverse,
...
_mvn_doc_frozen_callparams_note = \
    """See CustomClass definition for a detailed description of parameters."""
...
# multivariate_normal_gen and fill in default strings in CustomClass docstrings
...
# Set frozen generator docstrings from corresponding docstrings in
# matrix_normal_gen and fill in default strings in CustomClass docstrings
...
# Set frozen generator docstrings from corresponding docstrings in
# Wishart and fill in default strings in CustomClass docstrings
...
# Set frozen generator docstrings from corresponding docstrings in
# inverse Wishart and fill in default strings in CustomClass docstrings
...
# Set frozen generator docstrings from corresponding docstrings in
# multinomial and fill in default strings in CustomClass docstrings
...
class special_ortho_group_gen(multi_rv_generic):
    ...
    Notes
    ----------
    This CustomClass is wrapping the random_rot code from the MDP Toolkit,
...
class ortho_group_gen(multi_rv_generic):
    ...
    Notes
    ----------
    This CustomClass is closely related to `special_ortho_group`.
...
class unitary_group_gen(multi_rv_generic):
    ...
    Notes
    ----------
    This CustomClass is similar to `ortho_group`.
