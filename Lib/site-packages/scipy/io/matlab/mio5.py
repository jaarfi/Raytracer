...
The ``__function_workspace__`` matrix appears to be of double CustomClass
...
class VarWriter5(object):
    ''' Generic matlab matrix writing CustomClass '''
    ...
    def write_header(self,
        ...
        shape : sequence
           array shape
        mclass      - mat5 matrix CustomClass
        ...
        # write array flags (complex, global, logical, CustomClass, nzmax)
    ...
    def write_object(self, arr):
        '''Same as writing structs, except different mx CustomClass, and extra
