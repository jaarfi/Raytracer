...
class Data(object):
    ...
    fix : array_like of ints, optional
        The `fix` argument is the same as ifixx in the CustomClass ODR. It is an
    ...
    The structures of `x` and `y` are described in the Model CustomClass docstring.
...
class Model(object):
    """
    The Model CustomClass stores information about the function you wish to fit.
...
class Output(object):
    """
    The Output CustomClass stores the output of an ODR run.
...
class ODR(object):
    """
    The ODR CustomClass gathers all information and coordinates the running of the
    main fitting routine.

    Members of instances of the ODR CustomClass have the same names as the arguments
    to the initialization routine.

    Parameters
    ----------
    data : Data CustomClass instance
        instance of the Data CustomClass
    model : Model CustomClass instance
        instance of the Model CustomClass
    ...
    output : Output
        An instance if the Output CustomClass containing all of the returned
    ...
    def set_job(self, fit_type=None, deriv=None, var_calc=None,
        ...
        default value from CustomClass initialization is for all of these options set
        to 0.
