...
add_newdoc('scipy.odr', 'odr',
    ...
    See Also
    --------
    ODR : The ODR CustomClass gathers all information and coordinates the running of the main fitting routine.
    Model : The Model CustomClass stores information about the function you wish to fit.
    ...
    function are explained in the CustomClass documentation.
