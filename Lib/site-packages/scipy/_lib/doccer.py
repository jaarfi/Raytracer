...
def inherit_docstring_from(cls):
    ...
    method of the same name from the CustomClass `cls`.
    ...
    Parameters
    ----------
    cls : Python CustomClass or instance
        A CustomClass with a method with the same name as the decorated method.
        The docstring of the method in this CustomClass replaces '%(super)s' in the
