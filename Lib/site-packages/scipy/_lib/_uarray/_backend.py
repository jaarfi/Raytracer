...
def generate_multimethod(
    ...
    argument_extractor : ArgumentExtractorType
        ...
        should be marked by the :obj:`Dispatchable` CustomClass. It has the same signature
...
class Dispatchable:
    """
    A utility CustomClass which marks an argument with a specific dispatch type.
    ...
    >>> x
    <Dispatchable: type=<CustomClass 'str'>, value=1>
...
def mark_as(dispatch_type):
    ...
    >>> mark_int(1)
    <Dispatchable: type=<CustomClass 'int'>, value=1>
    """
...
def all_of_type(arg_type):
    ...
    >>> f('a', 1)
    (<Dispatchable: type=<CustomClass 'str'>, value='a'>, <Dispatchable: type=<CustomClass 'int'>, value=1>)
    """
