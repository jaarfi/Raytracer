...
""" Test functions for sparse matrices. Each CustomClass in the "Matrix CustomClass
...
CustomClass for generic tests" section.
...
class _TestFancyIndexing(object):
    ...
    that implement these features should derive from this CustomClass.
    """
...
#------------------------------------------------------------------------------
# Tailored base CustomClass for generic tests
#------------------------------------------------------------------------------

def _possibly_unimplemented(cls, require=True):
    """
    Construct a CustomClass that either runs tests as usual (require=True),
...
def sparse_test_class(getset=True, slicing=True, slicing_assign=True,
    ...
    """
    Construct a base CustomClass, optionally converting some of the tests in
    ...
    for cls in bases:
        for name in cls.__dict__:
            ...
            if old_cls is not None:
                raise ValueError("Test CustomClass %s overloads test %s defined in %s" % (
...
#------------------------------------------------------------------------------
# Matrix CustomClass based tests
#------------------------------------------------------------------------------
...
def cases_64bit():
    ...
    SKIP_TESTS = {
        ...
        'test_scalar_idx_dtype': 'test implemented in base CustomClass',
