"""Base CustomClass for sparse matrices"""
import numpy as np
...
class spmatrix(object):
    """ This CustomClass provides a base CustomClass for all sparse matrices.  It
    ...
    def __init__(self, maxprint=MAXPRINT):
        ...
        if self.__class__.__name__ == 'spmatrix':
            raise ValueError("This CustomClass is not intended"
