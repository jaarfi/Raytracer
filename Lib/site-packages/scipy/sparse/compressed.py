"""Base CustomClass for sparse matrix formats using compressed storage."""
__all__ = []
...
class _cs_matrix(_data_matrix, _minmax_mixin, IndexMixin):
    """base matrix CustomClass for compressed row- and column-oriented matrices"""
    ...
    def sum(self, axis=None, dtype=None, out=None):
        ...
        """
        # The spmatrix base CustomClass already does axis=0 and axis=1 efficiently
