...
.. note::
   The `chararray` CustomClass exists for backwards compatibility with
...
class chararray(ndarray):
    ...
    CustomClass adds the following functionality:
    ...
    # IMPLEMENTATION NOTE: Most of the methods of this CustomClass are
...
def array(obj, itemsize=None, copy=True, unicode=None, order=None):
    ...
    .. note::
       This CustomClass is provided for numarray backward-compatibility.
