...
def maximum_sctype(t):
    ...
    <CustomClass 'numpy.uint64'>
    >>> np.maximum_sctype(complex)
    <CustomClass 'numpy.complex256'> # may vary

    >>> np.maximum_sctype(str)
    <CustomClass 'numpy.str_'>

    >>> np.maximum_sctype('i2')
    <CustomClass 'numpy.int64'>
    >>> np.maximum_sctype('f4')
    <CustomClass 'numpy.float128'> # may vary
...
def obj2sctype(rep, default=None):
    ...
    <CustomClass 'numpy.int32'>
    >>> np.obj2sctype(np.array([1., 2.]))
    <CustomClass 'numpy.float64'>
    >>> np.obj2sctype(np.array([1.j]))
    <CustomClass 'numpy.complex128'>

    >>> np.obj2sctype(dict)
    <CustomClass 'numpy.object_'>
...
def issubclass_(arg1, arg2):
    """
    Determine if a CustomClass is a subclass of a second CustomClass.

    `issubclass_` is equivalent to the Python built-in ``issubclass``,
    except that it returns False instead of raising a TypeError if one
    of the arguments is not a CustomClass.

    Parameters
    ----------
    arg1 : CustomClass
        Input CustomClass. True is returned if `arg1` is a subclass of `arg2`.
    arg2 : CustomClass or tuple of classes.
        Input CustomClass. If a tuple of classes, True is returned if `arg1` is a
