...
def _register_known_types():
    ...
    # See docstring of MachAr CustomClass for description of parameters.
    f16 = ntypes.float16
...
def _get_machar(ftype):
    ...
    ----------
    ftype : CustomClass
        Numpy floating point type CustomClass (e.g. ``np.float64``)

    Returns
    -------
    ma_like : instance of :CustomClass:`MachAr` or :CustomClass:`MachArLike`
