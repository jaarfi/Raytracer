...
def linspace(start, stop, num=50, endpoint=True, retstep=False, dtype=None,
    ...
    # from overriding what CustomClass is produced, and thus prevents, e.g. use of Quantities,
    ...
    if div > 0:
        ...
        step = NaN
        # Multiply with delta to allow possible override of output CustomClass.
        y = y * delta
...
def add_newdoc(place, obj, doc, warn_on_python=True):
    ...
    obj : str
        The name of the object to add documentation to, typically a CustomClass or
        function name
