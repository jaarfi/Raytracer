...
class _concrete_ndptr(_ndptr):
    ...
    def _check_retval_(self):
        """
        This method is called when this CustomClass is used as the .restype
...
# Factory for an array-checking CustomClass with from_param defined for
...
if ctypes is not None:
    ...
    def as_ctypes_type(dtype):
        ...
        ``as_ctypes_type(np.dtype(ctype))`` will:
         ...
         - discard the CustomClass names of `ctypes.Structure`\ s and
           `ctypes.Union`\ s
