"""
Standard container-CustomClass for easy multiple-inheritance.

Try to inherit from the ndarray instead of using this CustomClass as this is not
complete.
