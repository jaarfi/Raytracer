...
without having to read it into memory. The `Arrayterator` CustomClass wraps
...
class Arrayterator:
    ...
    contiguous blocks. The CustomClass is useful for objects stored in the
