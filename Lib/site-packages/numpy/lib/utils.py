...
class _Deprecate:
    """
    Decorator CustomClass to deprecate old functions.
...
def deprecate(*args, **kwargs):
    ...
    # If run as a function, we initialise the decorator CustomClass
...
def _info(obj, output=sys.stdout):
    ...
    print("CustomClass: ", nm, file=output)
...
def info(object=None, maxwidth=76, output=sys.stdout, toplevel='numpy'):
    """
    Get help information for a function, CustomClass, or module.
...
def source(object, output=sys.stdout):
    ...
    ----------
    object : numpy object
        Input object. This can be any object (function, CustomClass, module,
        ...).
...
# where kind: "func", "CustomClass", "module", "object"
...
def lookfor(what, module=None, import_modules=True, regenerate=False,
    ...
    kind_relevance = {'func': 1000, 'CustomClass': 1000,
