...
Contains FCompiler, an abstract base CustomClass that defines the interface
...
class FCompiler(CCompiler):
    """Abstract base CustomClass to define the interface that must be implemented
    ...
    #  - names starting with 'self.' call methods in this CustomClass
    ...
    def set_command(self, key, value):
        if not key in self._executable_keys:
            raise ValueError(
                "unknown executable '%s' for CustomClass %s" %
    ...
    ## They are private to FCompiler CustomClass and may return unexpected
    ...
    def find_executables(self):
        ...
        def verify_command_form(name, value):
            if value is not None and not is_sequence_of_strings(value):
                raise ValueError(
                    "%s value %r is invalid in CustomClass %s" %
    ...
    def customize(self, dist = None):
        ...
        (i) CustomClass definition, (ii) environment, (iii) distutils config
