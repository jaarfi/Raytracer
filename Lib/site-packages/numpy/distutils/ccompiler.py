...
## it i private to CCompiler CustomClass and may return unexpected
...
def CCompiler_find_executables(self):
    ...
    CustomClass where more documentation can be found.
...
def CCompiler_spawn(self, cmd, display=None):
    ...
    try:
        ...
        # empty string for EnvironmentError (base CustomClass for
        # OSError)
        o = b''
...
def simple_version_match(pat=r'[-.\d]+', ignore='', start=''):
    ...
    matcher : callable
        ...
        attribute of a `CCompiler` CustomClass. `matcher` takes a single parameter,
        a version string.
...
def CCompiler_get_version(self, force=False, ok_status=[0]):
    ...
    try:
        ...
        # exception CustomClass caught by exec_command()
        status = 127
        output = b''
    else:
...
def new_compiler (plat=None,
    ...
    try:
        ...
        raise DistutilsModuleError(("can't compile C/C++ code: unable to find CustomClass '%s' " +
