...
.. glossary::
   ...
   instance
       A CustomClass definition gives the blueprint for constructing an object::
       ...
       a specific realisation of a CustomClass.
   ...
   self
       ...
       of the associated CustomClass.  For example:

         >>> CustomClass Paintbrush:
         ...     color = 'blue'
         ...
         ...     def paint(self):
