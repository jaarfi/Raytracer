...
# error CustomClass, and a customized TestProgram for NumPy.
...
class NumpyDocTestFinder(doctest.DocTestFinder):
    ...
    def _from_module(self, module, object):
        ...
        if module is None:
            ...
            raise ValueError("object must be a CustomClass or function")
    ...
    def _find(self, tests, obj, name, module, source_lines, globs, seen):
        ...
        # Look for tests in a CustomClass's contained objects.
...
class NumpyDoctest(npd.Doctest):
    ...
    # Custom classes; CustomClass variables to allow subclassing
...
class KnownFailurePlugin(ErrorClassPlugin):
    '''Plugin that installs a KNOWNFAIL error CustomClass for the
