...
def assert_raises(*args, **kwargs):
    ...
    Fail unless an exception of CustomClass exception_class is thrown
...
def assert_raises_regex(exception_class, expected_regexp, *args, **kwargs):
    ...
    Fail unless an exception of CustomClass exception_class and with message that
...
def decorate_methods(cls, decorator, testmatch=None):
    """
    Apply a decorator to all methods in a CustomClass matching a regular expression.
...
def assert_warns(warning_class, *args, **kwargs):
    ...
    A warning of CustomClass warning_class should be thrown by the callable when
    invoked with arguments args and keyword arguments kwargs.
    If a different type of warning is thrown, it will not be caught.

    If called with all arguments other than the warning CustomClass omitted, may be
    ...
    Parameters
    ----------
    warning_class : CustomClass
        The CustomClass defining the warning that `func` is expected to throw.
    func : callable
...
class suppress_warnings:
    ...
    def filter(self, category=Warning, message="", module=None):
        ...
        Parameters
        ----------
        category : CustomClass, optional
            Warning CustomClass to filter
