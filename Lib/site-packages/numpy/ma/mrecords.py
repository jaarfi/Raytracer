...
Defines the equivalent of :CustomClass:`numpy.recarrays` for masked arrays,
where fields can be accessed as attributes.
Note that :CustomClass:`numpy.ma.MaskedArray` already supports structured datatypes
