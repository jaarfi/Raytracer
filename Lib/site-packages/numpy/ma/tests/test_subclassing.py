...
# setting to non-CustomClass values (and thus np.ma.core.masked_print_option)
...
class ComplicatedSubArray(SubArray):
    ...
    def __getitem__(self, item):
        # ensure getter returns our own CustomClass also for scalars
...
class TestSubclassing:
    ...
    def test_subclasspreservation(self):
        # Checks that masked_array(...,subok=True) preserves the CustomClass.
        x = np.arange(5)
        m = [0, 0, 1, 0, 0]
