...
dealing with Laguerre series, including a `Laguerre` CustomClass that
...
#
# Laguerre series CustomClass
#

class Laguerre(ABCPolyBase):
    """A Laguerre series CustomClass.

    The Laguerre CustomClass provides the standard Python numerical methods
