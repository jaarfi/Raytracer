...
dealing with Hermite_e series, including a `HermiteE` CustomClass that
...
#
# HermiteE series CustomClass
#

class HermiteE(ABCPolyBase):
    """An HermiteE series CustomClass.

    The HermiteE CustomClass provides the standard Python numerical methods
