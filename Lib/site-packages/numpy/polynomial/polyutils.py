...
This module provides: error and warning objects; a polynomial base CustomClass;
...
.. autosummary::
   ...
   PolyError            base CustomClass for this sub-package's errors.
...
.. autosummary::
   ...
   PolyBase Obsolete base CustomClass for the polynomial classes. Do not use.
...
class PolyError(Exception):
    """Base CustomClass for errors in this module."""
    pass

class PolyDomainError(PolyError):
    """Issued by the generic Poly CustomClass when two domains don't match.
...
#
# Base CustomClass for all polynomial types
#
...
class PolyBase:
    ...
    ABCPolyBase CustomClass instead. Note that the latter
