...
dealing with Chebyshev series, including a `Chebyshev` CustomClass that
...
def poly2cheb(pol):
    ...
    is to use the convert method of a CustomClass instance.
...
#
# Chebyshev series CustomClass
#

class Chebyshev(ABCPolyBase):
    """A Chebyshev series CustomClass.

    The Chebyshev CustomClass provides the standard Python numerical methods
