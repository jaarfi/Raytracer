...
dealing with Hermite series, including a `Hermite` CustomClass that
...
#
# Hermite series CustomClass
#

class Hermite(ABCPolyBase):
    """An Hermite series CustomClass.

    The Hermite CustomClass provides the standard Python numerical methods
