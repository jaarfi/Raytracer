...
dealing with Legendre series, including a `Legendre` CustomClass that
...
#
# Legendre series CustomClass
#

class Legendre(ABCPolyBase):
    """A Legendre series CustomClass.

    The Legendre CustomClass provides the standard Python numerical methods
