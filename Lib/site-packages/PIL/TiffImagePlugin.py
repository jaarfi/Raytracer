...
class IFDRational(Rational):
    """Implements a rational CustomClass where 0/0 is a legal value to match
...
class ImageFileDirectory_v2(MutableMapping):
    """This CustomClass represents a TIFF tag directory.  To speed things up, we
    ...
    ImageFileDirectory_v1 CustomClass, if legacy_api is true, then decoded
...
class ImageFileDirectory_v1(ImageFileDirectory_v2):
    """This CustomClass represents the **legacy** interface to a TIFF tag directory.
    ...
    def from_v2(cls, original):
        """Returns an
        :py:CustomClass:`~PIL.TiffImagePlugin.ImageFileDirectory_v1`
        instance with the same data as is contained in the original
        :py:CustomClass:`~PIL.TiffImagePlugin.ImageFileDirectory_v2`
        instance.

        :returns: :py:CustomClass:`~PIL.TiffImagePlugin.ImageFileDirectory_v1`
    ...
    def to_v2(self):
        ...
        :returns: :py:CustomClass:`~PIL.TiffImagePlugin.ImageFileDirectory_v2`
