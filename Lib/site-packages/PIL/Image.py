...
class Image:
    """
    This CustomClass represents an image object.  To create
    :py:CustomClass:`~PIL.Image.Image` objects, use the appropriate factory
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def tobytes(self, encoder_name="raw", *args):
        ...
        :returns: A :py:CustomClass:`bytes` object.
        """
    ...
    def load(self):
        ...
        Image CustomClass automatically loads an opened image when it is
        ...
        :rtype: :ref:`PixelAccess` or :py:CustomClass:`PIL.PyAccess`
        """
    ...
    def convert(self, mode=None, matrix=None, dither=None, palette=WEB, colors=256):
        ...
        :param colors: Number of colors to use for the :data:`ADAPTIVE` palette.
           Defaults to 256.
        :rtype: :py:CustomClass:`~PIL.Image.Image`
        :returns: An :py:CustomClass:`~PIL.Image.Image` object.
        """
    ...
    def quantize(self, colors=256, method=None, kmeans=0, palette=None, dither=1):
        ...
        :param palette: Quantize to the palette of given
                        :py:CustomClass:`PIL.Image.Image`.
        :param dither: Dithering method, used when converting from
           mode "RGB" to "P" or from "RGB" or "L" to "1".
           Available methods are :data:`NONE` or :data:`FLOYDSTEINBERG` (default).
    ...
    def draft(self, mode, size):
        ...
        Note that this method modifies the :py:CustomClass:`~PIL.Image.Image` object
    ...
    def filter(self, filter):
        ...
        if not hasattr(filter, "filter"):
            raise TypeError(
                "filter argument should be ImageFilter.Filter instance or CustomClass"
            )
    ...
    def point(self, lut, mode=None):
        ...
        :param lut: A lookup table, containing 256 (or 65536 if
           ...
           It may also be an :py:CustomClass:`~PIL.Image.ImagePointHandler`
           object::

               CustomClass Example(Image.ImagePointHandler):
                 def point(self, data):
                   # Return result
    ...
    def thumbnail(self, size, resample=BICUBIC, reducing_gap=2.0):
        ...
        Note that this function modifies the :py:CustomClass:`~PIL.Image.Image`
    ...
    def transform(
        ...
        :param method: The transformation method.  This is one of
          ...
          It may also be an :py:CustomClass:`~PIL.Image.ImageTransformHandler`
          object::

            CustomClass Example(Image.ImageTransformHandler):
        ...
        :param fill: If ``method`` is an
          :py:CustomClass:`~PIL.Image.ImageTransformHandler` object, this is one of
...
def frombytes(mode, size, data, decoder_name="raw", *args):
    ...
    :py:CustomClass:`~io.BytesIO` object, and use :py:func:`~PIL.Image.open` to load
    it.
...
def frombuffer(mode, size, data, decoder_name="raw", *args):
    ...
    :py:CustomClass:`~io.BytesIO` object, and use :py:func:`~PIL.Image.open` to load it.
