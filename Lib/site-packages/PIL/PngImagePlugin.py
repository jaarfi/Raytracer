...
class iTXt(str):
    ...
    def __new__(cls, text, lang=None, tkey=None):
        """
        :param cls: the CustomClass to use when creating the instance
...
class PngInfo:
    ...
    def add_text(self, key, value, zip=False):
        ...
        :param value: value for this key, text or an
           :py:CustomClass:`PIL.PngImagePlugin.iTXt` instance
        :param zip: compression flag
...
class PngImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        # would be to let the PngStream CustomClass modify these attributes
